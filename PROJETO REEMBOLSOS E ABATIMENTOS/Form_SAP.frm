...
Private Sub btn_OK_SAP_Click()
    ...
    If texto_data = "" Or _
        (Me.opt_luana_approver = False And Me.opt_thiago_approver = False And Me.opt_outro_approver = True And Me.txt_box_outro_approver = "") Then
...
Private Sub UserForm_Initialize()
    ...
    With Me
      ...
      .txt_box_data_agrupado_pgto_SAP.tabStop = True
      .opt_luana_approver.tabIndex = 1
      .opt_luana_approver.tabStop = True
      .opt_thiago_approver.tabIndex = 2
      .opt_thiago_approver.tabStop = True
      .opt_outro_approver.tabIndex = 3
      .opt_outro_approver.tabStop = True
      .opt_ambos.tabIndex = 4
      .opt_ambos.tabStop = True
      .opt_ambos = True
      .opt_apenas_abatimentos.tabIndex = 5
      .opt_apenas_abatimentos.tabStop = True
      .opt_apenas_reembolsos.tabIndex = 6
      .opt_apenas_reembolsos.tabStop = True
      .btn_OK_SAP.tabIndex = 4
      .btn_OK_SAP.tabStop = True
      .btn_cancelar_SAP.tabIndex = 5
      .btn_cancelar_SAP.tabStop = True
      .opt_thiago_approver = False
      .opt_outro_approver = False
      .txt_box_outro_approver.Visible = False
      .lbl_outro_biz.Visible = False
      .opt_luana_approver = True
      .opt_luana_approver.SetFocus
